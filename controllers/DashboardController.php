...
class DashboardController extends MemberController
{
    ...
    public function actionAdmin()
    {
        ...
        return $this->render('admin', [
            ...
            'totalStockist' => $totalStockist, 'totalMobile' => $totalMobile, 'totalMember' => $totalMember, 'totalSale' => $totalSale, 'totalBonus' => $totalBonus, 'totalRepeat' => $totalRepeat, 'totalEwallet' => $totalEwallet, 'totalPoint' => $totalPoint
        ]);
    }
